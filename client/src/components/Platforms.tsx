  ...
  return (
    <section id="platforms" className="py-16 px-6 bg-white">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Three cards arranged in descending layout */}
        <div className="space-y-8">
          {/* ChatGPT Card */}
          <Card className="bg-maroon text-white card-shadow transition-all duration-300 hover:shadow-xl ml-0">
            <CardContent className="p-8">
              ...
              <Button className="bg-white text-maroon px-6 py-3 rounded-xl font-semibold hover:bg-gray-100 transition-all duration-300 w-full">
          ...
          {/* Advocate Card - slightly indented */}
          <Card className="bg-maroon text-white card-shadow transition-all duration-300 hover:shadow-xl ml-8">
            <CardContent className="p-8">
              <div className="flex items-center space-x-4 mb-6">
                <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center">
          ...
          {/* MyVote Card - most indented */}
          <Card className="bg-maroon text-white card-shadow transition-all duration-300 hover:shadow-xl ml-16">
            <CardContent className="p-8">
              <div className="flex items-center space-x-4 mb-6">
                <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center">
